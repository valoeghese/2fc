...
public class MoveableRect extends GUI {
	...
	public void setPosition(float xOffset, float yOffset) {
		...
		int tl = this.vertex(xOffset + aspect * this.protoVertices[0][0], yOffset + this.protoVertices[0][1], this.z, 0, 1);
		int bl = this.vertex(xOffset + aspect * this.protoVertices[1][0], yOffset + this.protoVertices[1][1], this.z, 0, 0);
		int tr = this.vertex(xOffset + aspect * this.protoVertices[2][0], yOffset + this.protoVertices[2][1], this.z, 1, 1);
		int br = this.vertex(xOffset + aspect * this.protoVertices[3][0], yOffset + this.protoVertices[3][1], this.z, 1, 0);
